...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--train_path", default="./data/processed/train.txt", required=False,
                        type=str, help="The path of train set.")
    parser.add_argument("-d", "--dev_path", default="./data/processed/dev.txt", required=False,
