...
# 模型
model = AutoModelForTokenClassification.from_pretrained("D:\\python_project\\test\\smart_edu\\pretrained\\bert-base-chinese",
...
# 分词器
tokenizer = AutoTokenizer.from_pretrained("D:\\python_project\\test\\smart_edu\\pretrained\\bert-base-chinese")
# 数据整理器
