...
class ChatService:
    def __init__(self):
        self.llm = ChatOpenAI(model_name='gpt-5')
        ...
        self.neo4j_vectors = {
            ...
            keyword_index_name='test_paper_question_full_text_index',
            search_type=SearchType.HYBRID
    ...
    def _generate_cypher(self,question):
        prompt = """
                    ...
                    知识图谱结构信息：{schema_info}
                        要求：
                        1. 生成参数化Cypher查询语句，用param_0, param_1等代替具体值,注意用$符号占位
                        2. 识别需要对齐的实体
